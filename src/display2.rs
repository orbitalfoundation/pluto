...
pub fn old(recv:&Receiver<Message>) {
...
pub fn display(recv:&Receiver<Message>) {

    let opengl = OpenGL::V3_2;


    let mut window: PistonWindow = WindowSettings::new("Orbital", [400,600]).exit_on_esc(true).graphics_api(OpenGL::V3_2).build().unwrap();
